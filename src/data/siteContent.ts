...
export const treatments: Treatment[] = [
  {
    ...
    longDescription:
      "Com o passar do tempo, mudanças na produção de colágeno e na estrutura da face podem alterar contorno, sustentação e aparência. O Lifting Essencial foi pensado para trabalhar esses sinais de maneira integrada.",
    indications: [
  ...
  },
  {
    ...
    longDescription:
      "Cada rosto possui proporções próprias. Na Arquitetura Facial, analisamos essas proporções antes de decidir se algum ponto realmente precisa ser tratado.",
    indications: [
      "Contorno mandibular",
      "Queixo",
      "Lábios",
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Colágeno Ativo",
      label: "Colágeno Ativo",
    },
    longDescription:
      "A redução progressiva de colágeno influencia firmeza, textura e sustentação. Colágeno Ativo utiliza estímulos planejados para desencadear um processo gradual de remodelação da pele.",
    indications: [
      "Flacidez",
      "Textura irregular",
      "Poros",
  ...
  },
  {
    ...
    longDescription:
      "Manchas, textura, poros e falta de luminosidade podem interferir na percepção geral da aparência. Pele de Luz foi criado para trabalhar justamente a qualidade da pele.",
    indications: [
  ...
  },
  {
    ...
    longDescription:
      "A região dos olhos possui características próprias e precisa ser avaliada de maneira específica.",
    indications: [
  ...
  // No price supplied for this complementary care.
  {
    ...
    longDescription:
      "Cuidado complementar planejado conforme as necessidades da sua pele e a avaliação individual.",
    indications: [],
    technologies: [],
    price: 180,
    detail: false,
...
export const technologies: Technology[] = [
  {
    ...
    description:
      "Estimula colágeno e atua na sustentação e definição do contorno facial.",
    applications: [
      "Sustentação",
  ...
  },
  {
    ...
    description:
      "Combina microagulhamento e energia para estimular remodelação, firmeza e melhora da textura da pele.",
    applications: [
      "Radiofrequência microagulhada",
      "Firmeza e textura",
      "Remodelação da pele",
...
export const faqs: FAQ[] = [
  [
    ...
    "Começamos pela avaliação da sua pele, estrutura facial, histórico e objetivos para construir um planejamento individual.",
  ],
  [
    "Preciso fazer vários procedimentos?",
    "Não necessariamente. A avaliação considera o que faz sentido para você, inclusive quando a indicação é um único cuidado.",
  ],
  [
    "Os resultados são imediatos?",
    "A evolução depende do tratamento e da resposta individual. Alguns cuidados têm evolução gradual; o prazo esperado será explicado na avaliação.",
  ],
  [
    "Quantas sessões são necessárias?",
    "A quantidade é definida após a avaliação e pode ser ajustada durante o acompanhamento.",
  ],
  [
    "Vou ficar com aparência artificial?",
    "O planejamento busca respeitar suas proporções e identidade. Objetivos, limites e expectativas são conversados antes de qualquer indicação.",
  ],
  [
    "Os procedimentos doem?",
    "A sensibilidade varia conforme a pessoa e a técnica. Os cuidados para conforto e as sensações esperadas são explicados antes do procedimento.",
  ],
  [
    "Existe tempo de recuperação?",
    "Pode existir, dependendo da técnica. Os cuidados e o retorno às atividades são explicados na avaliação.",
  ],
  [
    "Posso fazer mais de um tratamento?",
    "Em alguns planejamentos, sim. A combinação e os intervalos dependem da avaliação individual e da compatibilidade das técnicas.",
  ],
  [
    "Como funciona a primeira consulta?",
    "Conversamos sobre suas queixas, objetivos e histórico, avaliamos seu rosto e apresentamos as possibilidades de cuidado.",
  ],
  [
...
export const testimonials: Testimonial[] = [
  {
    id: "mariana",
    quote:
      "Eu queria me cuidar sem mudar meu rosto. Desde a primeira avaliação, senti que cada indicação tinha um motivo e respeitava o que eu realmente precisava. O resultado ficou leve, natural e muito mais alinhado com o que eu imaginava.",
    name: "Mariana Tavares",
    role: "42 anos · Paciente Vellune",
    rating: "★★★★★",
    image: {
...

  {
    id: "juliana",
    quote:
      "O que mais gostei foi não sentir que estavam tentando me vender procedimentos. A proposta foi construída aos poucos, com muita clareza. Minha pele melhorou, meu rosto ficou mais descansado e continuo me reconhecendo completamente.",
    name: "Juliana Rocha",
    role: "38 anos · Paciente Vellune",
    rating: "★★★★★",
    image: {
...

  {
    id: "fernanda",
    quote:
      "Depois de algumas experiências que não me deixaram satisfeita, encontrei uma abordagem muito mais cuidadosa. A avaliação foi detalhada e o resultado ficou sofisticado, discreto e natural. Era exatamente o que eu procurava.",
    name: "Fernanda Nogueira",
    role: "47 anos · Paciente Vellune",
    rating: "★★★★★",
    image: {
