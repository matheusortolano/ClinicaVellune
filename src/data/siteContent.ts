...
export const technologies: Technology[] = [
  {
    ...
    image: photo("FOTOGRAFIA • ULTRASSOM MICROFOCADO"),
  },
  {
    ...
    image: photo("FOTOGRAFIA • RADIOFREQUÊNCIA"),
  },
  {
    slug: "thulium",
    ...
    related: ["pele-de-luz"],
    image: photo("FOTOGRAFIA • LASER DE THULIUM"),
  },
];
...
export const testimonials: Testimonial[] = Array.from(
  ...
  (_, i) => ({
    id: String(i),
    quote: "[Inserir depoimento real da paciente aqui.]",
    name: "[Nome da paciente]",
    role: "Paciente Vellune",
...
export const results: Result[] = [
  ...
  id: String(i),
  beforeImage: photo("ANTES"),
  afterImage: photo("DEPOIS"),
  treatment: category,
  objective: "Fotografias reais serão inseridas posteriormente.",
  period: "",
  category,
}));
export const siteContent = {
  ...
  hero: {
    eyebrow: "PRECISÃO NO CUIDADO. NATURALIDADE NO RESULTADO.",
    headline: "O tempo muda. Você não precisa deixar de se reconhecer.",
    text: "Tratamentos faciais personalizados para prevenir, harmonizar e cuidar da sua pele com naturalidade.",
    videoSrc: "",
    poster: "",
